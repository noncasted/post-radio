...
public static class DbExtensions
{
    ...
    public static void AddParameter<T>(
        this IDbCommand command, string parameterName, T value, ParameterDirection direction,
        int? size = null, DbType? dbType = null)
    {
        command.Parameters.Add(command.CreateParameter(direction, parameterName, value, size));
    }
    
    public static void AddParameter<T>(this IDbCommand command, string parameterName, T value)
    {
