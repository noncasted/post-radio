---
name: report
description: Produce a concise work report for post-radio changes. Use when the user invokes /report or asks for a summary of completed work, changed files, verification, risks, or current task status.
---
