---
name: workflow-split
description: Save current task context into an active post-radio workflow workspace so a later Codex session can continue. Use when the user invokes /workflow-split or asks to preserve/hand off current workflow context.
---
