---
name: split-commit
description: Split the current working tree into multiple focused git commits. Use when the user invokes /split-commit or asks to divide changes into atomic commits.
---
...
- Post-radio scopes: `[Cluster]`, `[Meta]`, `[Infra]`, `[Orchestration]`, `[Frontend]`, `[Console]`, `[Common]`, `[Tools]`, `[Deploy]`, `[Docs]`, `[Tests]`, `[Bench]`.
