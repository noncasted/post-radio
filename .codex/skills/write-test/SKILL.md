...
1. Создать `backend/Tools/Tests/Tests.csproj` (Microsoft Testing Platform — см. `/test` skill за шаблоном csproj и `.codex/docs/CLAUDE_MISTAKES.md` lesson 1 за Lifetime-правилами).
