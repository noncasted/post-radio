---
name: branch-commit
description: Create a new git branch from the current branch and commit existing uncommitted changes there. Use when the user invokes /branch-commit or asks to move current work onto a new branch and commit it.
---
...
- `[Scope] Brief description` or `[Scope1] [Scope2] Brief description`
  ...
  - Scope: [Client], [Backend], [Shared], [Console], [Infra], [Tests], [Cards], [Docs], [Misc]
