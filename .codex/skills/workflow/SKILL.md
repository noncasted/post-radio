---
name: workflow
description: Create and maintain a structured post-radio task workspace under docs/tasks/current before implementation. Use when the user invokes /workflow or asks for a living task workspace with info, progress, and result files.
---
...
|-----------------|---------|
| Grain, State\<T\>, [Transaction], IOrleans, StateCollection, IMessaging, jsonb | `.codex/docs/COMMON_ORLEANS.md` |
| Lifetime, Advise, View, ListenQueue, DeployLifetime | `.codex/docs/COMMON_LIFETIMES.md` |
| Blazor, razor, @inject, UiComponent | `.codex/docs/BLAZOR.md` |
| Deploy, Coolify, docker-compose, Aspire, PgBouncer, migrator, DeployId, DeployIdentity | `.codex/docs/DEPLOY.md` |
| Deploy failure, compose logs, pgbouncer error | `.codex/docs/DEPLOY_TROUBLESHOOTING.md` |
| Code style, naming, Task vs UniTask | `.codex/docs/CODE_STYLE_FULL.md` |
| Telemetry, metrics, logs | `.codex/docs/TELEMETRY.md` |
| Past mistake / anti-pattern | `.codex/docs/CLAUDE_MISTAKES.md` |
| Terminology | `.codex/docs/VOCABULARY.md` |
| Error lookup | `.codex/docs/ERRORS.md` |
...
- `.codex/docs/COMMON_ORLEANS.md` — [конкретная причина]
