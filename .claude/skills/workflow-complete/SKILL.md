...
Check and update relevant docs in `.claude/docs/`.

### 6.1 — Mapping

| What changed in the task | Documentation to check/update |
|--------------------------|-------------------------------|
| New grain / state type / StateCollection | `docs/COMMON_ORLEANS.md` |
| New Lifetime usage pattern | `docs/COMMON_LIFETIMES.md` |
| New Blazor component / convention | `docs/BLAZOR.md` |
| Deploy changes (compose, AppHost, migrator, env vars) | `docs/DEPLOY.md` + `docs/DEPLOY_TROUBLESHOOTING.md` |
| New telemetry writer / layout change | `docs/TELEMETRY.md` |
| New vocabulary/concepts | `docs/VOCABULARY.md` |
| New error patterns | `docs/ERRORS.md` |
| AI mistakes made during task | `docs/CLAUDE_MISTAKES.md` |
| New doc file or major concept | `.claude/CLAUDE.md` keyword table + `docs/TRIGGERS.md` |
...
- `docs/COMMON_ORLEANS.md` — [what changed]
